...
namespace GalleryServerPro.Web.Api
{
	...
	public class AlbumsController : ApiController
	{
		...
		/// <see cref="Entity.Album.GalleryItems" />, <see cref="Entity.Album.Albums" />, and
		/// <see cref="Entity.Album.MediaItems" /> are set to null to keep the instance small.
		/// Example: api/albums/4/
		/// </summary>
				...
				var loadOptions = new Entity.GalleryDataLoadOptions
					{
						...
						NumAlbumsToRetrieve = top,
						NumAlbumsToSkip = skip
					};
		...
		/// <summary>
		/// Resort the items in the album according to the criteria and store this updated sequence in the
		...
		public void Sort(int id, int sortByMetaNameId, bool sortAscending)
		{
			try
			{
				var album = AlbumController.LoadAlbumInstance(id, true, true);
