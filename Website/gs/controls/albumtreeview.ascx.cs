...
(function ($) {{
  $(document).ready(function() {{
    var options = {{
      allowMultiSelect: {1},
      albumIdsToSelect: [{2}],
      checkedAlbumIdsHiddenFieldClientId: '{3}',
      theme: '{4}',
      requiredSecurityPermissions: {5},
      navigateUrl: '{6}'
    }};
...
",
 ...
 String.Join(",", SelectedAlbumIds), // 2
 hdnCheckedAlbumIds.ClientID, // 3
 TreeViewTheme, // 4
 (int)RequiredSecurityPermissions, // 5
 NavigateUrl, // 6
 TreeDataJson // 7
 );
